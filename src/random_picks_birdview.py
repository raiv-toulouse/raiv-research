...
# Constants
#
CROP_WIDTH = 224 # Width and height for rgb and depth cropped images
CROP_HEIGHT = 224
Z_PICK_PLACE = 0.1  # Z coord to start pick or place movement
X_OUT = 0.2  # XYZ coord where the robot is out of camera scope
Y_OUT = 0.1
Z_OUT = 0.1
...
coord_service = rospy.ServiceProxy('coord_service_name', get_coordServiceResponse)
...
while True:
    ...
    if object_gripped:
        ...
        robot.send_gripper_message(False)  # Switch off the gripper
